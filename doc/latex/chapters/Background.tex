...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{thread1}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{thread2}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{user-space-1}
\caption{User space: Word processor hits a bug}
\label{fig:User space}
\end{figure}
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{user-space-2}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{kernel-space-1}
\caption{Kernel space}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.5]{kernel-space-2}
\caption{Kernel space}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.55]{OS-arch}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=.4]{virtualization}
