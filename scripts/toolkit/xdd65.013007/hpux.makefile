...
CFLAGS =	-O2 -DHPUX -D_LARGEFILE64_SOURCE +DD64 -g
SHELL =	/bin/sh
PROJECT =	xdd
...
read_adfter_write.o:	read_adfter_write.c
	gcc  $(CFLAGS) -c read_adfter_write.c
